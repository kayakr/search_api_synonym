...
class SynonymViewsData extends EntityViewsData {
  ...
  public function getViewsData() {
    ...
    $data['search_api_synonym_field_data']['created_fulldata'] = array(
    ...
    $data['search_api_synonym_field_data']['created_year_month'] = array(
    ...
    $data['search_api_synonym_field_data']['created_year'] = array(
    ...
    $data['search_api_synonym_field_data']['created_month'] = array(
    ...
    $data['search_api_synonym_field_data']['created_day'] = array(
    ...
    $data['search_api_synonym_field_data']['created_week'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_fulldata'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_year_month'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_year'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_month'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_day'] = array(
    ...
    $data['search_api_synonym_field_data']['changed_week'] = array(
